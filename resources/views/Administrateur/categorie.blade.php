                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            <div class="row mb-4">
                                                <label for="designation" class="col-form-label col-lg-2">Désignation de la catégorie</label>
                                                <div class="col-lg-10">
                                                    <input id="designation" name="designation" type="text" class="form-control" placeholder="Entrer la désignation">
                                                </div>
                                            </div>
                                           
                                            <div class="row mb-4">
                                                <label for="photo" class="col-form-label col-lg-2">Photo de la catégorie</label>
                                                <div class="col-lg-10">
                                                    <input id="image" name="image" type="file" onchange="readURL(this);" class="form-control"  accept="image/png, image/gif, image/jpeg">
                                                </div>
                                          </div>   
