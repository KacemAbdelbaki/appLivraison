                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Modifier livreur</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Modifier les informations d'une catégorie</h4>
                                        <form action="{{ route('categorie.update') }}" method="POST"  enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$data->id}}" >

                                            <div class="row mb-4">
                                                <label for="nom" class="col-form-label col-lg-2">Désignation de la catégorie</label>
                                                <div class="col-lg-10">
                                                    <input id="designation" name="designation" type="text" class="form-control" value="{{$data->desgnation_categorie}}">
                                                </div>
                                            </div>
                                        	
											      <div class="row mb-4">
                                                <label class="col-form-label col-lg-2">Changer la photo de  la catégorie</label>
                                                <div class="col-lg-10">
                                    <input id="image" name="image" type="file" class="form-control" onchange="readURL(this);" class="form-control"  accept="image/png, image/gif, image/jpeg" >
                                    <br />
                                    <img src="{{asset('images/categorie/'.$data->photo_categorie)}}"  id="blah" width="200" height="150"/>
                                                </div>
                                            </div>
                                            <div class="row justify-content-end">
                                            <div class="col-lg-10">
                                                <button type="submit" class="btn btn-primary">Modifier information catégorie</button>
                                            </div>
                                        </div>
</form>                                    </div>
                                </div>
