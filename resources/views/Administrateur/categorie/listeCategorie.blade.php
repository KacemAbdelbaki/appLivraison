                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Vous pouvez supprimer ou modifier des informations concernant les catégories des plats</h4>
                                       <br />
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tr>
                                                <td style="vertical-align: middle;">{{$item->desgnation_categorie}}</td>
                                                <td style="vertical-align: middle;"> <img src="{{asset('images/categorie/'.$item->photo_categorie)}}" width="200" height="150" /></td>
                                                <td>
                                                <a href="/modifierCategorie/{{$item->id}}" class="btn btn-primary">Modifier</a>
                                                	<a href="/supprimerCategorie/{{$item->id}}" class="btn btn-danger" >Supprimer </a>
                                                </td>
